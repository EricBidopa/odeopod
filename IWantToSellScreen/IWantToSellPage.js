  ...
  return (
    <View style={styles.container}>
      <View style={styles.wrapper}>
        <Text style={styles.title}>I want To Sell $Jordan for ETH</Text>
        <Text>$Jordan Current Price : 0.05 ETH</Text>
        <View style={styles.labelAndInputView}>
          <Text style={styles.label}>Ask Price Per Share: </Text>
        ...
        <View style={styles.labelAndInputView}>
          <Text style={styles.label}>Sell Quantity: </Text>
          <View style={styles.inputAndETHView}>
            <TextInput
        ...
        <View style={styles.totalPriceContainer}>
          <Text style={styles.label}>Total Amount Ask:</Text>
        ...
        <SellConfirmModal show={showModal} onClose={closeModal}/>
      </View>
    </View>
  );
};

export default IWantToSellPage;
